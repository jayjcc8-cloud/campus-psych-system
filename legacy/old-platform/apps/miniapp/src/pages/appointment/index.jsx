...
export default function AppointmentPage() {
  ...
  return (
    <View className="page-shell">
      ...
      <AppCard tone="accent" className="booking-flow-hero">
        <View className="hero-copy-block">
          <Text className="hero-eyebrow">预约流程</Text>
          <Text className="hero-title">确认老师、时间和主题</Text>
          <Text className="hero-copy">提交前会再次弹窗确认，避免误操作。</Text>
        </View>
      ...
      <AppCard className="booking-card">
        <SectionHeader
          title="填写预约信息"
          extra={<Text className="count-badge">{visibleSchedules.length} 个可选</Text>}
        />
        ...
        <View className="form-stack">
          ...
          <View className="field-title-row">
            <Text className="field-label">时间段</Text>
            <Text className="inline-note">{selectedSchedule ? "已选择" : "请选择"}</Text>
          </View>
        ...
        <View className="submit-panel">
          ...
          <AppButton
            disabled={submitting || (!registrationSummary.blocking && !selectedScheduleId)}
            loading={submitting}
