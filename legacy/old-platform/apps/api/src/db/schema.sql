...
CREATE TABLE IF NOT EXISTS teacher_identity_bindings (
  id TEXT PRIMARY KEY,
  user_id TEXT NOT NULL UNIQUE,
...
CREATE INDEX IF NOT EXISTS idx_teacher_identity_bindings_status ON teacher_identity_bindings(status);
